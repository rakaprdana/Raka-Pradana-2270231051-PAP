#Operasi dan Memanipulasai String

#1. Menyambung String (concatenate)
nama_pertama="Ucup"
nama_tengah="D"
nama_akhir="Flaminggo"
...
print("Apakah "+d+" ada di "+nama_lengkap+", adalah "+str(status))
...
print("index ke-[0,2,4,6,8]: "+nama_lengkap[0:10:2]) #diambil dari index 0,2,4,6,8
